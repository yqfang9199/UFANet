...
def train_ddcnet(epoch, model, learning_rate, source_loader, drop, epochs_drop):
    """
    :param epoch: current training epoch
...
if __name__ == '__main__':
    ...
    for fold in [0]:
        ...
        source_batch_num = int(source_dataset_size / BATCH_SIZE)
        ...
        target_batch_num = int(target_dataset_size / BATCH_SIZE)

        print('Load data complete!')

        print('Construct model begin:')
        pre_ddcnet = pre_Model(in_channels=1, num_class=1, edge_importance_weighting=True)
        ...
        for epoch in range(1, TRAIN_EPOCHS + 1):
            ...
            train_ddcnet(epoch, pre_ddcnet, learning_rate, source_loader, drop, epochs_drop)
            correct = test_ddcnet(pre_ddcnet, target_test_loader)
